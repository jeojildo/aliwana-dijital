	...
	<div class="row" >
		<div class="col-md-12">
			<p>&nbsp;</p>
			 ...
			 <h6 class="text-center"> Utiliza hodi buka Titulu Monografia tuir Departementu (Jestaun Komputador / Sistema Informasaun)</h6>
			 <p>&nbsp;</p>
		</div> 
	</div>
</div>
...
<div class="container">  
    <div class="row">
			...
			<div class="col-md-4">
			 <h5>
	    	<form class="form-inline my-2 my-lg-0"  action="?page=hamosutitulutuirdepartementu" method="POST">
	      	<input class="form-control mr-sm-2"  type="text" name="liafuanxave" size="20" autofocus autocomplete="off" required placeholder="Buka Tuir Departementu" aria-label="buka">
...
if(isset($_POST['buka'])){
	...
	$query=mysqli_query($conn, "SELECT monografia.nie, estudante.naranestudante, 
				...
				WHERE departementu	= '$liafuanxave'");
