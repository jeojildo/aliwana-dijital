<?
include_once"bdjpnadmin/config/koneksaun.php";
...
<?
echo "<br>";
echo "<a href='bdjpnadmin/modulsbdjpn/monografia/download.php?file=$row[abstratud]'>Download Abstratu Monografia</a>";
echo "<br>";
echo "<br>";
